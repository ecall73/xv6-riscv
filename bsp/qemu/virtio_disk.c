...
disk_init(void)
{
  ...
  *R(VIRTIO_MMIO_QUEUE_DESC_HIGH) = (uint64)(uint32)disk.desc >> 32;
  *R(VIRTIO_MMIO_DRIVER_DESC_LOW) = (uint32)disk.avail;
  *R(VIRTIO_MMIO_DRIVER_DESC_HIGH) = (uint64)(uint32)disk.avail >> 32;
  *R(VIRTIO_MMIO_DEVICE_DESC_LOW) = (uint32)disk.used;
  *R(VIRTIO_MMIO_DEVICE_DESC_HIGH) = (uint64)(uint32)disk.used >> 32;
